...
/**
 * 前端indexSubHeader可选项枚举
 *
 * @author lmy
 * @date 2023/4/13 3:18 PM
 **/
public enum IndexOptionSubHeaderEnum {
    ...
    public static IndexOptionSubHeaderEnum toEnum(String value) {
        for (IndexOptionSubHeaderEnum valueType : IndexOptionSubHeaderEnum.values()) {
    ...
    public static IndexOptionSubHeaderEnum getInstance(String desc) {
        for (IndexOptionSubHeaderEnum valueType : IndexOptionSubHeaderEnum.values()) {
    ...
    public static List<IndexOptionSubHeaderEnum> getRequireByType(Integer type) {
        ArrayList<IndexOptionSubHeaderEnum> results = Lists.newArrayList();
        for (IndexOptionSubHeaderEnum valueType : IndexOptionSubHeaderEnum.values()) {
    ...
    IndexOptionSubHeaderEnum(String value, String desc, Integer type, Integer groupId, Boolean require, String content) {
        this.value = value;
        this.desc = desc;
        this.type = type;
